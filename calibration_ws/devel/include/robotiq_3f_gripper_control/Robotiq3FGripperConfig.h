...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.mode = 0;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(Robotiq3FGripperConfig::AbstractParamDescriptionConstPtr(new Robotiq3FGripperConfig::ParamDescription<int>("mode", "int", 0, "The grasping mode", "{'enum': [{'name': 'Basic', 'type': 'int', 'value': 0, 'srcline': 37, 'srcfile': '/home/robot/calibration_ws/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg', 'description': 'Basic mode', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Pinch', 'type': 'int', 'value': 1, 'srcline': 38, 'srcfile': '/home/robot/calibration_ws/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg', 'description': 'Pinch mode', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Wide', 'type': 'int', 'value': 2, 'srcline': 39, 'srcfile': '/home/robot/calibration_ws/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg', 'description': 'Wide mode', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Scissor', 'type': 'int', 'value': 3, 'srcline': 40, 'srcfile': '/home/robot/calibration_ws/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg', 'description': 'Scissor mode', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'An enum to set the grasp operation mode'}", &Robotiq3FGripperConfig::mode)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(Robotiq3FGripperConfig::AbstractParamDescriptionConstPtr(new Robotiq3FGripperConfig::ParamDescription<int>("mode", "int", 0, "The grasping mode", "{'enum': [{'name': 'Basic', 'type': 'int', 'value': 0, 'srcline': 37, 'srcfile': '/home/robot/calibration_ws/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg', 'description': 'Basic mode', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Pinch', 'type': 'int', 'value': 1, 'srcline': 38, 'srcfile': '/home/robot/calibration_ws/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg', 'description': 'Pinch mode', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Wide', 'type': 'int', 'value': 2, 'srcline': 39, 'srcfile': '/home/robot/calibration_ws/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg', 'description': 'Wide mode', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Scissor', 'type': 'int', 'value': 3, 'srcline': 40, 'srcfile': '/home/robot/calibration_ws/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg', 'description': 'Scissor mode', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'An enum to set the grasp operation mode'}", &Robotiq3FGripperConfig::mode)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 37 "/home/robot/calibration_ws/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg"
      const int Robotiq3FGripper_Basic = 0;
//#line 38 "/home/robot/calibration_ws/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg"
      const int Robotiq3FGripper_Pinch = 1;
//#line 39 "/home/robot/calibration_ws/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg"
      const int Robotiq3FGripper_Wide = 2;
//#line 40 "/home/robot/calibration_ws/src/robotiq/robotiq_3f_gripper_control/cfg/Robotiq3FGripper.cfg"
