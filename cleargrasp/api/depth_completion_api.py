...
class DepthToDepthCompletion(object):
    ...
    def store_depth_completion_outputs(self, root_dir, files_prefix, min_depth=0.0, max_depth=1.5):
        ...
        mask_valid_region_3d = cv2.cvtColor(self.mask_valid_region,cv2.COLOR_GRAY2RGB)
        mask_rgb = cv2.cvtColor(self.mask_predicted,cv2.COLOR_GRAY2RGB)
        ...
        grid_image2 = np.concatenate(
            (orig_input_depth_rgb, input_depth_rgb, output_depth_rgb, mask_rgb, mask_valid_region_3d), 1)
